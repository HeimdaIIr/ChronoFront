...
class Result extends Model
{
    ...
    /**
     * Calculate time from individual start, wave start, or race TOP DÉPART
    ...
    public function calculateTime(): void
    {
        ...
        if ($this->entrant && $this->entrant->start_time) {
            ...
            // Combiner la date du passage avec l'heure de départ individuelle
            $startDateTime = \Carbon\Carbon::parse($rawTime->format('Y-m-d') . ' ' . $this->entrant->start_time);
